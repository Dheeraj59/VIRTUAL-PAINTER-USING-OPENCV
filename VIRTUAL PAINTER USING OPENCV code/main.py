...
brushThickness = 25
eraserThickness = 100
drawColor = (255, 0, 0)  # setting blue color(which is initial color)
...
folderPath = "Header"
myList = os.listdir(folderPath)  # getting all the images
...
while True:
    ...
    if len(lmList) != 0:
        ...
        if fingers[1] and fingers[2]:
            ...
            # checking for click
            if y1 < 125:
                if 250 < x1 < 450:  # if i m clicking at blue brush
                    header = overlayList[3]
                    drawColor = (255, 0, 0)
                elif 550 < x1 < 750:  # if i m clicking at red brush
    ...
    imgInv = cv2.cvtColor(imgInv,
                          cv2.COLOR_GRAY2BGR)  # converting again to gray
    ...
    img[0:124, 0:1280] = header  # on our frame we are setting our JPG image acc to H,W of jpg images
